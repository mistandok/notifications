...
GET_USER_PREFERENCES_LIST_DESCRIPTION = """&emsp;Ручка позволяет получить информацию по предпочтениям для заданных пользовательских идентификаторов.<br><br>&emsp;`Args`:<br>&emsp;&emsp;user_ids: список пользователей, по которым необходимо получить информацию. Не более 1000 пользователей за раз.<br>&emsp;&emsp;only_with_events: показывать только тех пользователей, которые подписаны хотябы на одно уведомление.<br><br>&emsp;`Returns`:<br>&emsp;&emsp;list[UserPreferences]<br>  """
